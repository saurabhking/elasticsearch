...
public class ElasticSearchBean {
    ...
    private static final String INDEX_NAME = "ui";
            ...
            if(null == selectArticle)
                ...
                ClientProvider.instance().getClient().prepareUpdate(INDEX_NAME, TYPE_NAME, selectArticle.getId().toString())
                        .setScript("ctx._source.title=title; ctx._source.content=content; "
                                ...
                                + "ctx._source.tags=tags", ScriptType.INDEXED)
                        .setScriptParams(updateObject).execute().actionGet();*/

				ClientProvider.instance().getClient().prepareIndex(INDEX_NAME, TYPE_NAME, selectArticle.getId().toString())
				.setSource(putJsonDocument(selectArticle.getId(), selectArticle.getTitle(), selectArticle.getContent(),
						selectArticle.getPostDate(), postTags,
						selectArticle.getAuthor())).execute().actionGet();
